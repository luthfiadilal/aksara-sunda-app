...
class Rarangken extends StatefulWidget {
  @override
  State<Rarangken> createState() => _RarangkenState();
}

class _RarangkenState extends State<Rarangken> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    ...
    final swaraAksara = viewModel.aksaras
        .where((aksara) => aksara.tipe == 'Rarangken')
        .toList();

    return Scaffold(
      appBar: AppBar(title: Text('Aksara Rarangken')),
